...
This is a public lab demo deployment. It does not provide enterprise IAM, managed persistence, production authorization, regulated-system access, SOC 2 certification, or production enforcement authority.
